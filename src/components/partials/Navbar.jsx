...
const Navbar = () => {
  ...
  return (
    <>
    <div
      className={`${isOpenNav ? "-translate-y-0 sticky" : "sticky"} top-0 py-8 bg-white transition-transform duration-300 z-[10] ${
    ...
    {isOpenNav && (
      <div className="flex fixed bg-white items-center justify-center gap-10 w-full h-screen flex-col py-5 z-10 transition-transform duration-300">
        {users ? (
          <span className="text-[15px]">Welcome, {users?.username}</span>
        ) : ""}
